...
public class ClientHandler implements Runnable{
    ...
    public void run() {
        ...
        String serverMessage = "join`:`" + clientUsername;
        ...
        try {
            while(socket.isConnected()) {
                ...
                if(destination.equals("group")){
                    messageFromClient = "group`:`"+clientUsername+"`:`"+destAndMsg[1];
                    ...
                    if(dest.isPresent()){
                        ...
                        this.bufferedWriter.write("doesn't exist`:`" + destination);
    ...
    private void closeEverything(Socket socket, BufferedWriter bufferedWriter, BufferedReader bufferedReader) {
        ...
        String serverMessage = "left`:`" + clientUsername;
        broadcastMessage(serverMessage);
        try {
